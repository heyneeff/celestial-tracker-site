...
const CACHE_NAME = 'ct12-demo-v1'; // distinct from planet-tracker's own SW cache name — same origin (heyneeff.github.io), different scope, but Cache Storage is keyed per-origin not per-scope
const PRECACHE_URLS = [
  './',
  './index.html',
  './manifest.json',
